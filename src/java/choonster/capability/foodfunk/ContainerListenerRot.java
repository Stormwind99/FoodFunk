...
public class ContainerListenerRot extends CapabilityContainerListener<IRot> {
	 ...
	 */
	@Override
	protected MessageBulkUpdateContainerRots createBulkUpdateMessage(final int windowID, final NonNullList<ItemStack> items) {
	 ...
	 */
	@Override
	protected MessageUpdateContainerRot createSingleUpdateMessage(final int windowID, final int slotNumber, final IRot icap) {
