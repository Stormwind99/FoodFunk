...
import com.wumple.foodfunk.capabilities.preserving.IPreserving;
import com.wumple.foodfunk.capabilities.preserving.PreservingProvider;
...
public class PreservingHelper
{
	 ...
	 *
	 * @param capability The IPreserving
	 * @return The provider
	 */
	public static ICapabilityProvider createProvider(IPreserving capability, TileEntity owner) {
		//return new SimpleCapabilityProvider<>(PreservingProvider.CAPABILITY, PreservingProvider.DEFAULT_FACING, capability);
		
		return new PreservingProvider(PreservingProvider.CAPABILITY, PreservingProvider.DEFAULT_FACING, capability, owner);
	}
}
