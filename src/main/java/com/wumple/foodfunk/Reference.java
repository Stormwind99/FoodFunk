...
public class Reference
{
    ...
    public static final String DEPENDENCIES = "required-after:wumpleutil@[2.10,);before:quark;before:biomesoplenty;before:erebus;before:aquaculture;before:betterwithmods";
