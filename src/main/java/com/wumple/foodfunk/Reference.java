...
public class Reference
{
    ...
    public static final String DEPENDENCIES = "required-after:wumpleutil@[2.11,);after:waila;after:hwyla;after:theoneprobe;before:quark;before:biomesoplenty;before:erebus;before:aquaculture;before:betterwithmods";
