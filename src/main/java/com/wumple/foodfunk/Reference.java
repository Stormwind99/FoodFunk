...
public class Reference
{
    ...
    public static final String DEPENDENCIES = "required-after:wumpleutil@[2.11,);before:quark;before:biomesoplenty;before:erebus;before:aquaculture;before:betterwithmods";
